// <copyright file="P_ObjectToolOverrideSystem.cs" company="Luca Rager">
...
namespace Platter.Systems {
    ...
    /// <summary>
    /// Ovverides object placement to snap parcels to road sides and swap prefab from placeholder to actual parcel.
    /// </summary>
    public partial class P_ObjectToolOverrideSystem : GameSystemBase {
        ...
        protected override void OnCreate() {
            ...
            // Logger
            m_Log = new PrefixedLogger(nameof(P_ObjectToolOverrideSystem));
        ...
        protected override void OnUpdate() {
            ...
            var parcelSnapJobHandle = new ParcelSnapJob(
                ...
                parcelPlaceholderDataComponentLookup: SystemAPI.GetComponentLookup<ParcelPlaceholderData>(true),
        ...
        private struct ParcelSnapJob : IJobChunk {
            ...
            [ReadOnly] private ComponentLookup<ParcelPlaceholderData>   m_ParcelPlaceholderDataComponentLookup;
            ...
            public ParcelSnapJob(NativeQuadTree<Entity, Bounds2> zoneTree, NativeQuadTree<Entity, QuadTreeBoundsXZ> netTree,
                                 ...
                                 ComponentLookup<ParcelPlaceholderData> parcelPlaceholderDataComponentLookup, float snapSetback,
                ...
                m_ParcelPlaceholderDataComponentLookup = parcelPlaceholderDataComponentLookup;
            ...
            public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask,
                ...
                for (var i = 0; i < entityArray.Length; i++) {
                    ...
                    // Get some data
                    var parcelData = m_ParcelPlaceholderDataComponentLookup[creationDefinition.m_Prefab];
            ...
            private void CalculateHeight(ref ControlPoint controlPoint, ParcelPlaceholderData parcelData,
            ...
            public struct EdgeSnapIterator : INativeQuadTreeIterator<Entity, QuadTreeBoundsXZ> {
                ...
                private bool HandleGeometry(Entity entity) {
                    ...
                    if (MathUtils.Distance(
                            curve.m_Bezier.xz, m_ControlPoint.m_HitPosition.xz, out controlPoint.m_CurvePosition) >=
                        distance) {
                        return false;
                    }
