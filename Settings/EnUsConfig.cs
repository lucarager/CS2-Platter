    ...
    public class EnUsConfig : IDictionarySource {
        ...
        public EnUsConfig(PlatterModSettings setting) {
            ...
            m_Localization = new Dictionary<string, string>() {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(PlatterModSettings.PlatterToggleRender)), "Shortcut to toggle the rendering of parcel overlays on or off." },

                // ToggleSpawnActionName
                { m_Setting.GetBindingKeyLocaleID(PlatterModSettings.ToggleSpawnActionName), "Toggle \"Allow Spawning on Parcels\"" },
                { m_Setting.GetOptionLabelLocaleID(nameof(PlatterModSettings.PlatterToggleSpawn)), "Toggle \"Allow Spawning on Parcels\"" },
                { m_Setting.GetOptionDescLocaleID(nameof(PlatterModSettings.PlatterToggleSpawn)), "Shortcut to toggle allowing the spawning of buildings on parcels." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(PlatterModSettings.PlatterIncreaseParcelWidth)), "Increase Parcel width" },
                { m_Setting.GetOptionDescLocaleID(nameof(PlatterModSettings.PlatterIncreaseParcelWidth)), "Shortcut to increase Parcel width while plopping Parcels" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(PlatterModSettings.PlatterDecreaseParcelWidth)), "Decrease Parcel width" },
                { m_Setting.GetOptionDescLocaleID(nameof(PlatterModSettings.PlatterDecreaseParcelWidth)), "Shortcut to decrease Parcel width while plopping Parcels" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(PlatterModSettings.PlatterIncreaseParcelDepth)), "Increase Parcel depth" },
                { m_Setting.GetOptionDescLocaleID(nameof(PlatterModSettings.PlatterIncreaseParcelDepth)), "Shortcut to increase Parcel depth while plopping Parcels" },
                ...
                { "PlatterMod.UI.SectionTitle.SnapSpacing", "Road Snapping Spacing" },
