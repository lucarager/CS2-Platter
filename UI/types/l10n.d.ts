declare module "cs2/l10n" {
    import * as lang from "lang/en-US.json";
    import { FC, FunctionComponent, MemoExoticComponent } from "react";

    type PlatterStrings = keyof typeof lang;
    type GameStrings = `Assets.${string}`;
    type AvailableStringKeys = PlatterStrings | GameStrings;
