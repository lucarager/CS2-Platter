...
public partial class P_NewCellCheckSystem {
    ...
    public struct BlockCellsJob : Unity.Jobs.IJobParallelForDefer {
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Collections.NativeArray<Game.Zones.CellCheckHelpers.SortedEntity> m_Blocks;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Zones.Block> m_BlockLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Platter.Components.ParcelOwner> m_ParcelOwnerLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Platter.Components.ParcelData> m_ParcelDataLookup;

        [Unity.Collections.ReadOnlyAttribute]
        public required Colossal.Collections.NativeQuadTree<Unity.Entities.Entity, Game.Common.QuadTreeBoundsXZ> m_NetSearchTree;

        [Unity.Collections.ReadOnlyAttribute]
        public required Colossal.Collections.NativeQuadTree<Game.Areas.AreaSearchItem, Game.Common.QuadTreeBoundsXZ> m_AreaSearchTree;

        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Common.Owner> m_OwnerLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Objects.Transform> m_TransformLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Net.EdgeGeometry> m_EdgeGeometryLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Net.StartNodeGeometry> m_StartNodeGeometryLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Net.EndNodeGeometry> m_EndNodeGeometryLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Net.Composition> m_CompositionLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Prefabs.PrefabRef> m_PrefabRefLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Prefabs.NetCompositionData> m_NetCompositionLookup;

        [Unity.Collections.ReadOnlyAttribute]
        public required Unity.Entities.ComponentLookup<Game.Prefabs.RoadComposition> m_PrefabRoadCompositionLookup;

        [Unity.Collections.ReadOnlyAttribute]
        public required Unity.Entities.ComponentLookup<Game.Prefabs.AreaGeometryData> m_PrefabAreaGeometryLookup;

        [Unity.Collections.ReadOnlyAttribute]
        public required Unity.Entities.ComponentLookup<Game.Prefabs.ObjectGeometryData> m_PrefabObjectGeometryLookup;

        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.ComponentLookup<Game.Common.Native> m_NativeLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.BufferLookup<Game.Areas.Node>       m_AreaNodesLookup;
        [Unity.Collections.ReadOnlyAttribute] public required Unity.Entities.BufferLookup<Game.Areas.Triangle>   m_AreaTrianglesLookup;

        [Unity.Collections.NativeDisableParallelForRestrictionAttribute]
        public required Unity.Entities.BufferLookup<Game.Zones.Cell> m_CellsLookup;

        [Unity.Collections.NativeDisableParallelForRestrictionAttribute]
        public required Unity.Entities.ComponentLookup<Game.Zones.ValidArea> m_ValidAreaLookup;
        ...
        public void Execute(int index) {
            ...
            var validArea = new Game.Zones.ValidArea() {
            ...
            var corners   = Game.Zones.ZoneUtils.CalculateCorners(block, validArea);
        ...
        private static void NormalizeWideParcelCells(Game.Zones.Block                              block,
                                                     Platter.Components.ParcelData                 parcelData,
            ...
            for (var col = 0; col < block.m_Size.x; col++) {
                ...
                cell.m_State = Game.Zones.CellFlags.Blocked;
        ...
        /// <param name="parcelData"></param>
        /// <param name="cells"></param>
        private static void NormalizeNarrowParcelCells(Game.Zones.Block                              block,
                                                       Platter.Components.ParcelData                 parcelData,
                                                       Unity.Entities.DynamicBuffer<Game.Zones.Cell> cells) {
            for (var row = 0; row < block.m_Size.y; row++)
            for (var col = 0; col < block.m_Size.x; col++) {
                ...
                if (isOutsideLot) {
                    ...
                    cell.m_State &= ~Game.Zones.CellFlags.Occupied;
                }
        ...
        private static void CleanBlockedCells(Game.Zones.Block                              blockData,
                                              ref Game.Zones.ValidArea                      validAreaData,
                                              Unity.Entities.DynamicBuffer<Game.Zones.Cell> cells) {
            ...
            for (var i = validAreaData.m_Area.x; i < validAreaData.m_Area.y; i++) {
                ...
                if (((cell.m_State  & Game.Zones.CellFlags.Blocked) == Game.Zones.CellFlags.None) &
                    ((cell2.m_State & Game.Zones.CellFlags.Blocked) > Game.Zones.CellFlags.None)) {
                    cell.m_State |= Game.Zones.CellFlags.Blocked;
                    cells[i]     =  cell;
                }
                ...
                for (var j = validAreaData.m_Area.z + 1; j < validAreaData.m_Area.w; j++) {
                    ...
                    if (((cell3.m_State & Game.Zones.CellFlags.Blocked) == Game.Zones.CellFlags.None) &
                        ((cell.m_State  & Game.Zones.CellFlags.Blocked) > Game.Zones.CellFlags.None)) {
                        cell3.m_State |= Game.Zones.CellFlags.Blocked;
                        cells[num2]   =  cell3;
                    }
            ...
            for (var k = validAreaData.m_Area.z; k < validAreaData.m_Area.w; k++) {
                for (var l = validAreaData.m_Area.x; l < validAreaData.m_Area.y; l++) {
                    ...
                    if ((cell4.m_State & (Game.Zones.CellFlags.Blocked | Game.Zones.CellFlags.RoadLeft)) == Game.Zones.CellFlags.None && l > 0 &&
                        (cells[num3 - 1].m_State & (Game.Zones.CellFlags.Blocked | Game.Zones.CellFlags.RoadLeft)) ==
                        (Game.Zones.CellFlags.Blocked | Game.Zones.CellFlags.RoadLeft)) {
                        cell4.m_State |= Game.Zones.CellFlags.RoadLeft;
                        cells[num3]   =  cell4;
                    }

                    if ((cell4.m_State & (Game.Zones.CellFlags.Blocked | Game.Zones.CellFlags.RoadRight)) == Game.Zones.CellFlags.None &&
                        l < blockData.m_Size.x - 1 && (cells[num3 + 1].m_State & (Game.Zones.CellFlags.Blocked | Game.Zones.CellFlags.RoadRight)) ==
                        (Game.Zones.CellFlags.Blocked | Game.Zones.CellFlags.RoadRight)) {
                        cell4.m_State |= Game.Zones.CellFlags.RoadRight;
                        cells[num3]   =  cell4;
                    }
                }
            }
        ...
        private struct NetIterator : Colossal.Collections.INativeQuadTreeIterator<Unity.Entities.Entity, Game.Common.QuadTreeBoundsXZ> {
            ...
            public void Iterate(Game.Common.QuadTreeBoundsXZ bounds, Unity.Entities.Entity edgeEntity) {
                ...
                if (Colossal.Mathematics.MathUtils.Intersect(this.m_Bounds, edgeGeometry.m_Bounds.xz)) {
                    ...
                    var roadComposition    = default(Game.Prefabs.RoadComposition);
                ...
                if (Colossal.Mathematics.MathUtils.Intersect(this.m_Bounds, startNodeGeometry.m_Geometry.m_Bounds.xz)) {
                    ...
                    var roadComposition2    = default(Game.Prefabs.RoadComposition);
                ...
                if (Colossal.Mathematics.MathUtils.Intersect(this.m_Bounds, endNodeGeometry.m_Geometry.m_Bounds.xz)) {
                    ...
                    var roadComposition3    = default(Game.Prefabs.RoadComposition);
            ...
            private void CheckSegment(Colossal.Mathematics.Bezier4x3  left,
                                      ...
                                      Game.Prefabs.NetCompositionData prefabCompositionData,
                                      Game.Prefabs.RoadComposition    prefabRoadData,
                                      Unity.Mathematics.bool2         isEdge) {
                if ((prefabCompositionData.m_Flags.m_General & Game.Prefabs.CompositionFlags.General.Tunnel) !=
                    (Game.Prefabs.CompositionFlags.General)0U) {
                    return;
                }

                if ((prefabCompositionData.m_State & Game.Prefabs.CompositionState.BlockZone) == (Game.Prefabs.CompositionState)0) {
                    return;
                }

                var flag = (prefabCompositionData.m_Flags.m_General & Game.Prefabs.CompositionFlags.General.Elevated) >
                           (Game.Prefabs.CompositionFlags.General)0U;
                flag |= (prefabCompositionData.m_State & Game.Prefabs.CompositionState.ExclusiveGround) == (Game.Prefabs.CompositionState)0;
                ...
                isEdge &= ((prefabRoadData.m_Flags & Game.Prefabs.RoadFlags.EnableZoning) > (Game.Prefabs.RoadFlags)0) &
                          ((prefabCompositionData.m_Flags.m_General & Game.Prefabs.CompositionFlags.General.Elevated) ==
                           (Game.Prefabs.CompositionFlags.General)0U);
                isEdge &=
                    new Unity.Mathematics.bool2((prefabCompositionData.m_Flags.m_Left &
                                                 (Game.Prefabs.CompositionFlags.Side.Raised | Game.Prefabs.CompositionFlags.Side.Lowered)) ==
                                                (Game.Prefabs.CompositionFlags.Side)0U,
                                                (prefabCompositionData.m_Flags.m_Right & (Game.Prefabs.CompositionFlags.Side.Raised |
                                                                                          Game.Prefabs.CompositionFlags.Side.Lowered)) ==
                                                (Game.Prefabs.CompositionFlags.Side)0U);
                ...
                for (var i = 1; i <= 8; i++) {
                    ...
                    if (Colossal.Mathematics.MathUtils.Intersect(bounds3.xz, this.m_Bounds) &&
                        ...
                        var cellFlags = Game.Zones.CellFlags.Blocked;
                        if (isEdge.x) {
                            ...
                            cellFlags |= Game.Zones.ZoneUtils.GetRoadDirection(this.m_BlockData, block);
                        }

                        if (isEdge.y) {
                            var block2 = new Game.Zones.Block {
                                m_Direction = Unity.Mathematics.math.normalizesafe(Colossal.Mathematics.MathUtils.Left(quad.c.xz - quad.b.xz),
                                                                                   default(Unity.Mathematics.float2))
                            };
                            cellFlags |= Game.Zones.ZoneUtils.GetRoadDirection(this.m_BlockData, block2);
                        }
        ...
        private struct AreaIterator : Colossal.Collections.INativeQuadTreeIterator<Game.Areas.AreaSearchItem, Game.Common.QuadTreeBoundsXZ> {
            public bool Intersect(Game.Common.QuadTreeBoundsXZ bounds) {
                return Colossal.Mathematics.MathUtils.Intersect(bounds.m_Bounds.xz, this.m_Bounds);
            }

            public void Iterate(Game.Common.QuadTreeBoundsXZ bounds, Game.Areas.AreaSearchItem areaItem) {
                if (!Colossal.Mathematics.MathUtils.Intersect(bounds.m_Bounds.xz, this.m_Bounds)) {
                    return;
                }
                ...
                var triangle = Game.Areas.AreaUtils.GetTriangle3(dynamicBuffer, dynamicBuffer2[areaItem.m_Triangle]);
