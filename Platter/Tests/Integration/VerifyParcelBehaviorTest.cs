...
namespace Platter.Tests {
    ...
    public class VerifyParcelBehaviorTest : TestScenario {
                ...
                await TR.Describe(
                    ...
                    async () => {
                        ...
                        var parcelEntityAwayFromRoad = await PlaceParcel(
                            new PrefabID("ParcelPrefab", "Parcel 2x2"),
                            positionAwayFromRoad);
                        ...
                        TR.It(
                            ...
                            () => {
                                Assert.IsTrue(World.DefaultGameObjectInjectionWorld.EntityManager.TryGetBuffer<ConnectedParcel>(roadEdgEntity, true, out _));
                            });
                        TR.It(
                        ...
                        TR.It(
                            ...
                            () => {
                                ...
                                var subblockBuffer =
                                    World.DefaultGameObjectInjectionWorld.EntityManager.GetBuffer<ParcelSubBlock>(parcelEntityNextToExistingRoad);
                                var blockEntity = subblockBuffer[0].m_SubBlock;
        ...
        private async Task<Entity> PlaceParcel(PrefabID prefabID, Transform transform) { return await PlaceParcel(prefabID, transform, 0); }
