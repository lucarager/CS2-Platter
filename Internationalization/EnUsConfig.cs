    ...
    public class EnUsConfig : IDictionarySource {
        ...
        public EnUsConfig(PS setting) {
            ...
            m_Localization = new Dictionary<string, string>
            {
                ...
                { "PlatterMod.UI.Tooltip.SnapModeParcelEdge", "Snap parcel to existing parcels" },
                { "PlatterMod.UI.Tooltip.SnapModeParcelFrontAlign", "Snap parcel corners to existing parcel corners" },
